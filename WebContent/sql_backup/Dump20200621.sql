...
CREATE TABLE `member` (
  ...
  `mem_email` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mem_pwd` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mem_level` int NOT NULL DEFAULT '1' COMMENT '1:申請未確認\n2:已認證會員\n9:管理者',
  `mem_chknum` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'Null',
  `mem_cellphone` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '手機號碼',
...
INSERT INTO `member` VALUES (33,'林OO','109java01@gmail.com','Aa123',9,'026059',NULL,NULL),(34,'小花貓','cat@kitty.com','Aa123',2,'Null',NULL,NULL);
...
INSERT INTO `orderlist` VALUES (1,33,'2020-06-20 17:53:46','小鴿子','0922345678','天涯海角','dove@bird.com'),(2,33,'2020-06-20 17:55:38','小鴿子','0922345678','天涯海角','dove@bird.com'),(3,33,'2020-06-20 17:56:06','小鴿子','0922345678','天涯海角','dove@bird.com'),(4,33,'2020-06-20 18:01:06','小鴿子','0922345678','天涯海角','dove@bird.com'),(5,33,'2020-06-20 18:01:32','小鴿子','0922345678','天涯海角','dove@bird.com'),(6,33,'2020-06-20 18:05:34','小鴿子','0922345678','天涯海角','dove@bird.com');
...
INSERT INTO `orderlistdetail` VALUES (1,19,5),(1,20,1),(1,21,1),(2,19,2),(2,20,2),(2,21,1),(3,13,4),(3,14,2),(3,16,2),(3,17,2),(3,18,2),(3,21,3),(4,17,2),(4,18,3),(4,20,4),(5,15,1),(5,17,1),(5,18,2),(6,14,2),(6,15,1);
...
CREATE TABLE `product` (
  ...
  `prod_stocksize` int unsigned NOT NULL COMMENT '商品庫存',
...
INSERT INTO `product` VALUES (1,'小黑',500,'難用',1000,'C:MyGitHub	eamwebTeamWeb',0),(2,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(3,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(4,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(5,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(6,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(7,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(8,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(9,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(10,'小白',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(11,'小黑',10000,'難用',10,'C:MyGitHub	eamwebTeamWeb',0),(12,'小黑',100,'好用',50,'C:MyGitHub	eamwebTeamWeb',0),(13,'白色七分袖上衣',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',96,'C:MyGitHub	eamwebTeamWeb',1),(14,'橘色毛大衣',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',96,'C:MyGitHub	eamwebTeamWeb',1),(15,'紫色毛大衣',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',98,'C:MyGitHub	eamwebTeamWeb',1),(16,'純白聖誕大衣',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',98,'C:MyGitHub	eamwebTeamWeb',1),(17,'大紅聖誕大衣',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',92,'C:MyGitHub	eamwebTeamWeb',1),(18,'粉紅格子洋裝',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',85,'C:MyGitHub	eamwebTeamWeb',1),(19,'藍格子洋裝',100,'這是敘述，講這個裙子多漂亮！多舒服！布料多好！講述設計者的靈感來源、設計理念以及吹無與倫比毛求疵的匠人精神。一切都是為了讓人穿起來有著什麼樣舒適的觸覺體驗，給別人看起來有什麼樣的心理感受以及視覺暗示。',88,'C:MyGitHub	eamwebTeamWeb',1),(20,'海藍長裙',100,'「福爾摩沙」。神秘又美麗的海洋之島。沁心於深藍，令人意念徜徉於熱帶海洋般曠心。長版雙層設計於光照之下形成晴日海面般虛幻光影。沉穩色澤搭配外層質輕薄紗，隨風飄逸仿造真實鮮活的海洋波瀾。讓我們將移動的大海獻給來自福爾摩沙神秘且美麗的妳。',87,'C:MyGitHub	eamwebTeamWeb',1),(21,'粉紫長裙',1000,'採用台灣高海拔雪山蠶絲手工織打，整塊布料無接縫俐落剪裁。\r\n乾燥花般的淺紫淡粉，以色彩心理啟動清香甜美的意象味覺。\r\n唯有純粹質感才能呈現的簡約雅素，透過天然舒適的觸覺感受，讓人即使身處城市喧囂也不失原生俱來的仙靈氣動。',0,'C:MyGitHub	eamwebTeamWeb',1),(22,'小白',100,'好用',50,'C:MyGitHubMyTeamWebTeamWeb',0),(23,'小白',100,'好用',50,'C:MyGitHubMyTeamWebTeamWebWebContent',0),(24,'小白',100,'好用',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(25,'小黑',10000,'蝦',494,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(26,'小白',100,'好用s ',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(27,'哥吉拉',10000,'帥翻天',0,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(28,'vul3coi',100,'好用',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(29,'小黑',1000,'好吃',500,'C:\\\\MyGitHub\\\\MyTeamWeb\\\\TeamWeb\\\\WebContent',0),(30,'小白',1000,'好用',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(31,'小白',100,'好用123',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(32,'小白',1000,'好用',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(33,'小白',100,'好用123',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(34,'小白',100,'好用',500,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0),(35,'小白',1000,'好肥',50,'C:\\MyGitHub\\MyTeamWeb\\TeamWeb\\WebContent',0);
...
-- Dump completed on 2020-06-21  2:31:11
