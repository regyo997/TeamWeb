...
public class SearchAjaxController  extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int prod_stocksize = Integer.parseInt(request.getParameter("prod_stocksize"));
		
		//===
		Product product = new Product(prod_id, prod_name, prod_price, prod_introduction, prod_stocksize);
		...
		if (product.getProd_stocksize() < 1) {
